  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center md:px-10">
        ...
        >
          <MagneticCTA
            href="mailto:hello@trinetra.digital"
            primary
          >
            Book Free Consultation
          </MagneticCTA>
          <MagneticCTA href="https://wa.me/919000000000">
      ...
      {/* Footer */}
      <div className="relative mx-auto mt-24 max-w-7xl border-t border-white/8 px-6 pt-10 md:px-10">
        <div className="flex flex-col items-center justify-between gap-6 text-xs text-slate-600 md:flex-row">
          <div className="flex items-center gap-2.5">
            <img src="/TrinetraLogo.png" alt="Trinetra logo" className="h-8 w-auto opacity-70 premium-logo" />
            <span>© 2025 Trinetra Digital Solution. All rights reserved.</span>
          </div>
          <div className="flex gap-6">
            ...
            <a href="mailto:hello@trinetra.digital" className="hover:text-slate-400 transition-colors" data-hover>
              hello@trinetra.digital
            </a>
          </div>
        </div>
      </div>
