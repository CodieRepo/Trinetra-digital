    ...
    <>
      ...
      <section className="bg-white pt-20 pb-16 md:pt-24 md:pb-24 border-b border-slate-200">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-ink-1 mb-2 font-display">Legal Disclaimer</h1>
          ...
          <div className="flex flex-col gap-8 text-xs sm:text-sm text-slate-600 leading-relaxed text-left">
            ...
            <div>
              <h2 className="text-sm font-bold text-slate-900 mb-3 uppercase tracking-wider">2. Realistic Positioning &amp; Professional Copy</h2>
