...
const FORMSPREE_ID = "YOUR_FORMSPREE_ID"; // Replace at formspree.io/new
      ...
      <section className="bg-[#F4F2ED] py-20 md:py-28" aria-label="Contact Information and Form">
        <div className="main-container grid gap-12 lg:grid-cols-[1fr_1.4fr] lg:items-start">
          ...
          >
            ...
            >
              <input type="hidden" name="_subject" value="New Demo Request — Trinetra Digital Solution" />
              ...
              <button
                type="submit"
                className="mt-2 flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#2A4A3E] text-[#F9F8F5] text-xs font-bold uppercase tracking-wider hover:bg-[#1E3630] transition-colors"
              >
