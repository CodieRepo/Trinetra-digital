    ...
    <>
      ...
      <section className="bg-[#F9F8F5] py-16 border-b border-[#E2DDD5]">
        <div className="main-container max-w-[680px]">
          <h2 className="heading-md text-[#18170F] mb-6">Helping UP businesses grow with digital systems</h2>
      ...
      <section className="bg-[#F4F2ED] py-14">
        <div className="main-container text-center">
          <h2 className="heading-md text-[#18170F] mb-3">Start your digital growth journey in UP</h2>
